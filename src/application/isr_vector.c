...
extern void mira_Reset_Handler(void);
...
void mira_UARTE0_UART0_IRQHandler(void);
void mira_SPIM0_SPIS0_TWIM0_TWIS0_SPI0_TWI0_IRQHandler(void);
void SPIM1_SPIS1_TWIM1_TWIS1_SPI1_TWI1_IRQHandler(void);
void mira_NFCT_IRQHandler(void);
void GPIOTE_IRQHandler(void);
void mira_SAADC_IRQHandler(void);
...
void mira_WDT_IRQHandler(void);
void RTC1_IRQHandler(void);
void QDEC_IRQHandler(void);
void COMP_LPCOMP_IRQHandler(void);
void mira_SWI0_EGU0_IRQHandler(void);
void mira_SWI1_EGU1_IRQHandler(void);
void SWI2_EGU2_IRQHandler(void);
void SWI3_EGU3_IRQHandler(void);
void SWI4_EGU4_IRQHandler(void);
void SWI5_EGU5_IRQHandler(void);
void TIMER3_IRQHandler(void);
void mira_TIMER4_IRQHandler(void);
void PWM0_IRQHandler(void);
void PDM_IRQHandler(void);
void MWU_IRQHandler(void);
void PWM1_IRQHandler(void);
void PWM2_IRQHandler(void);
void mira_SPIM2_SPIS2_SPI2_IRQHandler(void);
void mira_RTC2_IRQHandler(void);
